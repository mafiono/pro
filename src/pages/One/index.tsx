...
const OnePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 font-montserrat h-[2653px] mx-auto relative w-full">
        <div className="flex flex-col h-full items-center justify-start ml-auto mr-52 mt-[105px] md:px-5 w-[66%]">
            ...
            <div className="flex flex-col items-center justify-start w-full">
              <div className="h-[400px] relative w-full">
                <Img
                  ...
                  alt="winninghomepage"
                />
                <div className="absolute flex flex-col items-center justify-start left-[6%] top-[21%] w-[31%]">
                  <div className="flex flex-col gap-4 items-center justify-center w-96 sm:w-full">
                    ...
                    <div className="flex flex-col items-center justify-start w-[59%] md:w-full">
                      ...
                      <div className="flex flex-col items-start justify-start mt-[13px] w-auto">
          ...
          <div className="bg-blue_gray-900_01 flex md:flex-col flex-row md:gap-10 items-center justify-between mt-4 p-5 rounded-md w-full">
            <Text
              ...
              <div className="flex sm:flex-col flex-row gap-1 items-start justify-start w-auto sm:w-full">
                ...
                <Button
                  ...
                  leftIcon={
                    <Img
                      className="h-6 mr-2"
                      src="images/img_user_lime_800.svg"
                      alt="user"
                    />
                  }
                  shape="round"
        ...
        <div className="absolute h-[2653px] md:h-[2808px] inset-[0] justify-center m-auto md:px-5 w-full">
          <div className="h-[2653px] md:h-[2808px] m-auto w-full">
          ...
          <PWAOneTopbar
            className="absolute bg-blue_gray-900 flex flex-row inset-x-[0] items-center justify-start mx-auto p-2.5 shadow-bs1 top-[0] w-full"
            megaphoneimage="images/img_megaphone.svg"
          />
        </div>
      </div>
    </>
