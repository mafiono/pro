...
const WithoutsidebarEight1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat mx-auto pb-[162px] relative w-full">
        <div className="bg-blue_gray-900_01 flex flex-col items-center justify-start mx-auto md:px-10 sm:px-5 px-[70px] w-full">
          <div className="h-[500px] max-w-[1780px] mx-auto relative w-full">
            ...
            <Img
              className="absolute h-[60px] inset-x-[0] mx-auto object-cover top-[4%]"
        ...
        <div className="flex flex-col gap-9 items-center justify-start max-w-[1264px] mt-[-45px] mx-auto md:px-5 w-full z-[1]">
          <div className="bg-blue_gray-800_02 flex flex-col items-center justify-center md:px-10 sm:px-5 px-[51px] py-6 rounded-md w-full">
              ...
              <div className="flex sm:flex-col flex-row gap-[45px] items-start justify-start w-auto sm:w-full">
                ...
                <div className="flex flex-row gap-[11px] items-start justify-start w-auto">
                  <Img
                    ...
                    src="images/img_frame48095798_blue_gray_800_07_30x30.svg"
                    alt="frame48095798"
                  />
                  <Text
                    className="text-white-A700 text-xs"
...
export default WithoutsidebarEight1Page;
