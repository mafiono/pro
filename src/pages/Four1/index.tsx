...
const Four1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[33px] items-center justify-start mx-auto pb-1 pl-1 w-full">
        <Header9 className="bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-center md:px-5 shadow-bs1 w-full" />
        <div className="flex flex-col gap-9 items-center justify-start max-w-[1265px] mb-[39px] mx-auto md:px-5 w-full">
          <div className="h-[337px] relative rounded-md w-full">
            <Img
              className="h-[337px] m-auto object-cover rounded-md w-full"
              src="images/img_image98_337x1264.png"
              alt="imageNinetyEight"
            />
            <div className="absolute bottom-[24%] flex md:flex-col flex-row md:gap-10 inset-x-[0] items-end justify-between mx-auto w-[94%]">
          ...
          <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col gap-[11px] items-start justify-start w-auto md:w-full">
              <List
                className="sm:flex-col flex-row gap-[11px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-start w-auto md:w-full"
                orientation="horizontal"
              >
                <div className="bg-blue_gray-800_06 flex flex-row items-center justify-between p-2.5 rounded-md w-[414px] sm:w-full">
                  <Img
                    className="h-5 w-6"
                    src="images/img_pwaicontournament1_20x24.svg"
                    alt="pwaicontourname"
                  />
          ...
          <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-auto md:w-full">
              ...
              >
                <div className="bg-blue_gray-800_06 flex flex-1 sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  ...
                  <div className="flex flex-row items-start justify-between w-[300px]">
                    <Text
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  <div className="flex flex-row gap-[30px] items-center justify-start w-auto">
                    <Img
                      className="h-5 w-6"
                      src="images/img_close_yellow_800_01_20x24.svg"
                      alt="close"
                    />
                    <Text
                  ...
                  <div className="flex flex-row items-center justify-between w-[300px]">
                    <Text
                      className="text-center text-sm text-yellow-800_01 w-auto"
                      size="txtMontserratBold14Yellow80001"
                    >
                      95000
                    </Text>
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  ...
                  <div className="flex flex-row items-center justify-between w-[300px]">
                    <Text
                      className="text-center text-gray-400_01 text-sm w-auto"
                      size="txtMontserratBold14Gray40001"
                    >
                      92000
                    </Text>
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  ...
                  <div className="flex flex-row items-center justify-between w-[300px]">
                    <Text
                      className="text-center text-lime-800_01 text-sm w-auto"
                      size="txtMontserratBold14Lime80001"
                    >
                      87000
                    </Text>
          ...
          <div className="flex flex-col gap-[13px] items-start justify-start w-auto md:w-full">
            <div className="flex flex-col items-center justify-start max-w-[1264px] w-full">
              <Text
                className="text-base text-white-A700 w-auto"
                size="txtMontserratBold16"
              >
            ...
            <List
              className="flex flex-col gap-[13px] items-center w-full"
              orientation="vertical"
            >
              <div className="md:flex-1 gap-4 grid sm:grid-cols-1 md:grid-cols-4 grid-cols-8 items-start justify-start w-auto md:w-full">
                <PWAOneGamecard
