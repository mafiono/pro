...
const WithoutsidebarSeven1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat mx-auto pb-[201px] relative w-full">
        <div className="bg-blue_gray-900_01 flex flex-col items-center justify-start mx-auto w-full">
          <div className="h-[500px] md:px-5 relative w-full">
            ...
            />
            <div className="absolute flex flex-col gap-[58px] justify-start left-[12%] top-[4%] w-[44%]">
              <Img
                className="h-[60px] md:h-auto md:ml-[0] ml-[401px] object-cover"
        ...
        <div className="flex flex-col gap-9 items-center justify-start max-w-[945px] mt-[-63px] mx-auto md:px-5 w-full z-[1]">
          <div className="bg-blue_gray-800_02 flex flex-col items-start justify-start px-3 py-6 rounded-md w-full">
            <div className="flex md:flex-col flex-row gap-[38px] items-center justify-start max-w-[919px] w-full">
              <Text
                className="text-white-A700 text-xl w-auto"
                size="txtMontserratBold20"
              >
              ...
              <div className="flex sm:flex-1 sm:flex-col flex-row gap-[45px] items-start justify-start w-auto sm:w-full">
                ...
                <div className="flex flex-row gap-[11px] items-start justify-start w-auto">
                  <Img
                    ...
                    src="images/img_frame48095798_30x30.svg"
                    alt="frame48095798"
                  />
                  <Text
                    className="text-white-A700 text-xs"
...
export default WithoutsidebarSeven1Page;
