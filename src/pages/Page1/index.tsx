...
const Page1: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-9 items-center justify-start mx-auto pb-3.5 w-full">
        ...
        <div className="flex flex-col gap-[51px] items-start justify-start max-w-[945px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-start justify-center max-w-[944px] py-1 w-full">
            <a
              href="javascript:"
          ...
          <div className="flex flex-col gap-8 items-start justify-start max-w-[945px] w-full">
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between max-w-[944px] w-full">
              <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-auto sm:w-full">
                ...
                ></Input>
                <TextArea
                  className="bg-gray-900 border-0 gap-2.5 h-[200px] leading-[normal] px-2.5 py-[11px] rounded text-center placeholder:text-gray-500 text-gray-500 text-xs w-[544px]"
                  name="inputs_One"
                  placeholder="Enter your Message"
                ></TextArea>
              </div>
              <div className="flex sm:flex-1 flex-col gap-5 h-[255px] md:h-auto items-start justify-start w-96 sm:w-full">
                ...
                <div className="flex flex-row gap-[19px] items-start justify-start w-auto">
                  <Img
                    ...
                    alt="iconsupportmess"
                  />
                  <div className="flex flex-col gap-1 items-start justify-start w-[234px]">
                    <Text
                      className="text-lg text-white-A700 w-auto"
                      size="txtMontserratBold18"
                    >
                    ...
                    <Text
                      className="max-w-[234px] md:max-w-full text-white-A700 text-xs"
