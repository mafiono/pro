...
const NinePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[33px] items-center justify-start mx-auto px-1 w-full">
          ...
          <div className="flex flex-col items-center justify-start w-full">
            ...
            >
              <div className="h-[337px] md:h-[393px] my-0 relative rounded-md w-full">
                ...
                />
                <div className="absolute flex md:flex-col flex-row md:gap-10 h-max inset-[0] items-center justify-between m-auto w-[94%]">
            ...
            <div className="flex flex-col items-center justify-start mt-[35px] rounded-md w-full">
              <div className="h-[344px] md:h-[364px] md:px-10 sm:px-5 px-[50px] py-10 relative rounded-md w-[1264px] md:w-full">
                <div className="h-[344px] md:h-[364px] m-auto w-full">
