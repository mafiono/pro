...
const Search2Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 font-montserrat h-[2117px] mx-auto relative w-full">
        <div className="absolute flex flex-col gap-[35px] h-max inset-[0] items-center justify-center m-auto max-w-[945px] md:px-5 w-full">
                  ...
                  <div className="absolute flex flex-col gap-2.5 h-full inset-[0] items-start justify-start m-auto max-w-[817px] w-full">
                    ...
                    >
                      <>
                        ...
                        studio Pragmatic Play. Released on 17.07.2020 it became
                        an instant success among gamblers for its immersive
                        engine and high-quality artwork. This review explains
                        all of its main characteristics that along with free
                        test mode available on Clash of Slots give a good idea
                        ...
                        and in the second version, thanks to the Megaways
                        engine, you have six reels with a different number of
                        symbols on each of them, which in total can provide the
                        maximum number of ways to win, namely 117649. A winning
                        combination is created when the same symbols appear on
                        successive reels in any position starting from the
                        first.
                        <br />
                        <br />
                        ...
                        Dog House Megaways has high dispersion, and RTP of
                        96.55%, while the maximum payout you can get is 12305
                        times your bet.
                      </>
                    </Text>
                  </div>
        ...
        <div className="absolute bg-blue_gray-900_e5 flex flex-col font-roboto gap-[19px] h-full inset-[0] items-center justify-center m-auto p-[60px] md:px-10 sm:px-5 w-full">
          <Input
            name="search_One"
