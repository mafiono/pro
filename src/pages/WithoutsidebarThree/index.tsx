...
const WithoutsidebarThreePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat items-center justify-start mx-auto pb-[38px] w-full">
        ...
        <div className="flex flex-col items-center justify-start max-w-[1264px] mt-[45px] mx-auto md:px-5 w-full">
        ...
        <div className="flex md:flex-col flex-row gap-4 items-start justify-start max-w-[1264px] mt-[35px] mx-auto md:px-5 w-full">
...
export default WithoutsidebarThreePage;
