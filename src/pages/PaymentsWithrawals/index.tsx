...
const PaymentsWithrawalsPage: React.FC = () => {
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      table1ColumnHelper.accessor("method", {
        cell: (info) => (
      ...
      table1ColumnHelper.accessor("fee", {
        cell: (info) => (
          <Text
            className="pb-[22px] pt-[11px] text-sm text-white-A700 tracking-[0.14px]"
            size="txtRobotoBold14"
      ...
      table1ColumnHelper.accessor("processingtime", {
        cell: (info) => (
          <Text
            className="pb-[22px] pt-[11px] text-sm text-white-A700 tracking-[0.14px]"
            size="txtRobotoBold14"
      ...
      table1ColumnHelper.accessor("limit", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("action", {
        cell: (info) => (
          <div className="flex flex-row font-montserrat items-center justify-evenly pb-[11px]">
            <Button
              className="border border-solid border-white-A700 cursor-pointer font-bold leading-[normal] min-w-[102px] text-center text-sm"
              shape="round"
              color="blue_gray_900"
              size="md"
              variant="fill"
            ...
            <div className="flex md:flex-1 sm:flex-col flex-row sm:gap-5 items-start justify-start w-[53%] md:w-full">
              <div className="h-[236px] relative w-[76%] sm:w-full">
                ...
                <Img
                  ...
                  src="images/img_star1_236x351.svg"
                  alt="starOne"
                />
              </div>
              <Img
          ...
          <div className="flex flex-col font-montserrat gap-4 items-start justify-start w-auto md:w-full">
            <div className="bg-gray-900 flex flex-col items-center justify-start max-w-[944px] p-1 rounded-md w-full">
              <div className="flex flex-row gap-[5px] items-start justify-start w-auto">
                <Button
                  className="common-pointer cursor-pointer font-bold h-10 leading-[normal] min-w-[134px] text-center text-white-A700 text-xs"
                  onClick={() => navigate("/")}
                  shape="round"
                  size="md"
                >
                ...
                <Button
                  className="cursor-pointer font-bold h-10 leading-[normal] min-w-[98px] text-center text-xs"
                  shape="round"
                  color="teal_400"
                  size="md"
                  variant="fill"
            ...
            >
              Casino offers dozens of fast and secure withdrawal methods without
              any fee.
            </Text>
          </div>
...
export default PaymentsWithrawalsPage;
