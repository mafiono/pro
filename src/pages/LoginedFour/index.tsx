...
const LoginedFourPage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[23px] items-center justify-start mx-auto pb-9 w-full">
        ...
        <div className="flex flex-col gap-9 items-center justify-start max-w-[945px] mx-auto md:px-5 w-full">
          <Img
            ...
            alt="20210324"
          />
          <div className="bg-gray-900 flex sm:flex-col flex-row sm:gap-10 h-12 md:h-auto items-center justify-between max-w-[944px] sm:px-5 px-6 py-1 rounded-md w-full">
...
export default LoginedFourPage;
