...
const Search1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 font-montserrat h-[2275px] mx-auto relative w-full">
        <div className="absolute flex flex-col gap-[35px] h-max inset-[0] items-center justify-center m-auto max-w-[1264px] md:px-5 w-full">
          <div className="flex flex-col gap-9 items-center justify-start w-full">
            <Img
              ...
              alt="20210324"
            />
            <div className="bg-gray-900 flex md:flex-col flex-row md:gap-10 h-12 md:h-auto items-center justify-between max-w-[1264px] sm:px-5 px-6 py-1 rounded-md w-full">
        ...
        <Header8 className="bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-center mx-auto md:px-5 shadow-bs1 w-full" />
        <div className="absolute bg-blue_gray-900_e5 flex flex-col font-roboto gap-[19px] h-full inset-[0] items-center justify-center m-auto p-[60px] md:px-10 sm:px-5 w-full">
          <Input
            ...
            wrapClassName="border border-solid border-teal-400 flex w-[71%]"
            prefix={
              <Img
            ...
            variant="fill"
          ></Input>
          <div className="flex flex-col font-montserrat gap-[13px] items-start justify-start max-w-[1264px] mb-[1649px] w-full">
