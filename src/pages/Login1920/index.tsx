...
import Login1920Inputs from "components/Login1920Inputs";

const Login1920Page: React.FC = () => {
  return (
    <>
      <div className="flex font-montserrat h-[1080px] justify-end mx-auto relative w-full">
        <Img
          ...
          alt="imageSeventy"
        />
        <div className="absolute bg-blue_gray-900_a2_01 flex flex-col h-full inset-[0] items-start justify-center m-auto p-[264px] md:px-10 sm:px-5 w-full">
          <div className="bg-gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-start ml-56 md:ml-[0] md:px-5 rounded-md shadow-bs5 w-[57%] md:w-full">
            ...
            <div className="bg-blue_gray-800_02 flex flex-col gap-4 h-[551px] md:h-auto items-center justify-center pb-2 pt-4 rounded-br-md rounded-tr-md w-[464px] sm:w-full">
              <Img
                className="h-6 w-6"
              ...
              <div className="flex flex-col gap-[15px] items-center justify-start w-[61%] md:w-full">
                ...
                <div className="flex flex-col gap-3.5 items-start justify-start w-auto">
                  <Input
                    ...
                    variant="fill"
                  ></Input>
                  <Login1920Inputs className="flex flex-col gap-1 items-start justify-start w-auto" />
                  <Text
