...
const FooterOnePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[33px] items-start justify-start mx-auto md:px-10 sm:px-5 px-[328px] py-9 w-auto sm:w-full md:w-full">
        <header className="flex md:flex-col flex-row md:gap-10 gap-[147px] items-center justify-center w-full">
          ...
          <div className="flex flex-col gap-2.5 items-start justify-start w-auto">
            <a href="javascript:" className="text-base text-white-A700 w-auto">
        ...
        <div className="flex flex-col gap-[18px] items-start justify-start max-w-[1258px] mx-auto w-full">
          <Text
        ...
        <div className="flex flex-col gap-[31px] items-start justify-start max-w-[1264px] mx-auto w-full">
          <div className="flex flex-col items-start justify-start max-w-[1264px] w-full">
            ...
            >
              ...
              address is Julianaplein 36, Willemstad, Curaçao. Friolion Limited
              is a subsidiary of Dama N.V., acting as an Agent on behalf of Dama
              N.V., registered in Cyprus with registered address Leandrou, 12A
              3086, Limassol, Cyprus, and registration number ΗΕ 419102. All
              payments with Paysafe are made via Dama N.V. Winning © Copyright
              2022.
            </Text>
          </div>
