...
const ButtonopenarchivePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[31px] items-center justify-start mx-auto pb-[62px] w-full">
...
export default ButtonopenarchivePage;
