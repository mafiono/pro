        ...
        <div className="flex flex-col gap-9 items-center justify-start max-w-[1265px] mb-[39px] mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-col gap-[11px] items-start justify-start w-auto md:w-full">
              ...
              >
                <div className="bg-blue_gray-800_06 flex flex-row items-center justify-between p-2.5 rounded-md w-[414px] sm:w-full">
                  <Img
                    className="h-5 w-6"
                    src="images/img_pwaicontournament1.svg"
                    alt="pwaicontourname"
                  />
                  <Text
                    className="text-right text-sm text-white-A700 w-auto"
                ...
                <div className="bg-blue_gray-800_06 flex flex-row items-center justify-between p-2.5 rounded-md w-[414px] sm:w-full">
                  <Img
                    className="h-5 w-6"
                    src="images/img_settings_gray_400_01.svg"
                    alt="settings"
                  />
                  <Text
                    className="text-right text-sm text-white-A700 w-auto"
                ...
                <div className="bg-blue_gray-800_06 flex flex-row items-center justify-between p-2.5 rounded-md w-[414px] sm:w-full">
                  <Img
                    className="h-5 w-6"
                    src="images/img_settings_lime_800_01.svg"
                    alt="settings"
                  />
                  <Text
                    className="text-right text-sm text-white-A700 w-auto"
          ...
          <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-auto md:w-full">
              ...
              >
                <div className="bg-blue_gray-800_06 flex flex-1 flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  <div className="flex flex-row gap-[30px] items-center justify-start w-auto">
                    <Img
                      className="h-5 w-6"
                      src="images/img_pwaicontournament1_yellow_800_01.svg"
                      alt="pwaicontourname"
                    />
                    <Text
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  <div className="flex flex-row gap-[30px] items-center justify-start w-auto">
                    <Img
                      className="h-5 w-6"
                      src="images/img_settings_gray_400_01_20x24.svg"
                      alt="settings"
                    />
                    <Text
                ...
                <div className="bg-blue_gray-900_01 flex flex-1 flex-row md:gap-10 items-center justify-between max-w-[1264px] pl-2.5 md:pr-10 pr-20 sm:pr-5 py-2.5 rounded-md w-full">
                  <div className="flex flex-row gap-[30px] items-center justify-start w-auto">
                    <Img
                      className="h-5 w-6"
                      src="images/img_settings_lime_800_01_20x24.svg"
                      alt="settings"
                    />
                    <Text
