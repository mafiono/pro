      ...
      <div className="bg-blue_gray-900 flex flex-col font-montserrat items-center justify-start mx-auto pb-9 w-full">
        <div className="flex flex-col gap-[23px] items-center justify-start w-full">
          ...
          <div className="flex flex-col font-roboto items-center justify-start max-w-[945px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between mt-[19px] w-full">
              <Img
                className="h-[321px] md:h-auto object-cover rounded-md"
                src="images/img_20210324.png"
                alt="20210324_Two"
              />
              <div className="bg-gray-900 flex sm:flex-1 flex-col items-center justify-center p-16 md:px-10 sm:px-5 rounded-md sm:w-full">
                <Input
                  name="search_One"
                  placeholder="Search Game"
                  className="!placeholder:text-white-A700_7f !text-white-A700_7f leading-[normal] p-0 text-center text-sm w-full"
                  wrapClassName="flex my-[76px] w-full"
                  prefix={
                    <Img
            ...
            <div className="bg-gray-900 flex sm:flex-col flex-row font-montserrat sm:gap-10 h-12 md:h-auto items-center justify-between max-w-[944px] mt-7 sm:px-5 px-6 py-1 rounded-md w-full">
