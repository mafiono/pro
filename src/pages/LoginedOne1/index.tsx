...
const LoginedOne1Page: React.FC = () => {
  return (
    <>
          ...
          <div className="flex flex-col font-roboto items-center justify-start max-w-[1264px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between mt-4 w-full">
              <Img
                ...
                alt="20210324_Two"
              />
              <div className="bg-gray-900 flex sm:flex-1 flex-col items-center justify-center p-20 md:px-10 sm:px-5 rounded-md sm:w-full">
                <Input
                  name="search_One"
                  placeholder="Search Game"
                  className="!placeholder:text-white-A700_7f !text-white-A700_7f leading-[normal] p-0 text-center text-sm w-full"
                  wrapClassName="flex my-[115px] w-full"
                  prefix={
                    <Img
...
export default LoginedOne1Page;
