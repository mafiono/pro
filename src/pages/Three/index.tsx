...
const ThreePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-9 items-center justify-start mx-auto pb-[141px] w-full">
        ...
        <div className="flex flex-col gap-[51px] items-center justify-start max-w-[945px] mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-col gap-4 items-center justify-start max-w-[944px] w-full">
            <Text
            ...
            <div className="bg-blue_gray-900_01 md:h-[250px] h-[302px] relative rounded-[5px] w-full">
              <div className="flex flex-col m-auto w-full">
                <div className="bg-blue_gray-800_05 flex flex-row gap-[42px] items-center justify-start mx-auto p-[15px] rounded-tl-[5px] rounded-tr-[5px] w-full">
                  <Text
              ...
              <div className="absolute flex flex-row gap-[45px] items-center justify-start left-[3%] top-[23%] w-[14%]">
                <Text
              ...
              <div className="absolute flex flex-row gap-11 items-center justify-start left-[3%] top-[38%] w-[14%]">
                <Text
                  className="text-center text-sm text-white-A700"
                  size="txtMontserratRegular14"
                >
              ...
              <div className="absolute bottom-[39%] flex flex-row gap-[42px] items-center justify-start left-[3%] w-[14%]">
                <Text
                  className="text-center text-sm text-white-A700"
                  size="txtMontserratRegular14"
                >
              ...
              <div className="absolute bottom-[22%] flex flex-row gap-11 items-center justify-start left-[3%] w-[14%]">
                <Text
                  className="text-center text-sm text-white-A700"
                  size="txtMontserratRegular14"
                >
              ...
              <div className="absolute bottom-[6%] flex flex-row gap-[43px] items-center justify-start left-[3%] w-[13%]">
                <Text
                  className="text-center text-sm text-white-A700"
                  size="txtMontserratRegular14"
                >
            ...
            <div className="flex flex-col gap-1 items-start justify-start max-w-[944px] w-full">
              <Text
                className="text-sm text-white-A700 w-auto"
                size="txtMontserratBold14"
              >
