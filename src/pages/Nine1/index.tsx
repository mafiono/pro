...
const Nine1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-9 items-center justify-start mx-auto pb-[38px] w-full">
        ...
        <div className="flex flex-col gap-[51px] items-start justify-start max-w-[945px] mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-9 items-center justify-start w-auto md:w-full">
            <div className="md:h-[435px] h-[527px] sm:h-[910px] relative w-[82%] md:w-full">
            ...
            <div className="flex flex-col gap-9 items-center justify-center max-w-[944px] w-full">
              <div className="flex flex-col gap-4 items-center justify-start w-auto md:w-full">
                <Text
                  className="max-w-[817px] md:max-w-full sm:text-4xl md:text-[38px] text-[40px] text-center text-white-A700"
                  size="txtMontserratBold40"
                >
                  Sorry, we couldn’t find the page you are looking for...
                </Text>
                <Text
                  className="leading-[160.00%] max-w-[944px] md:max-w-full text-base text-center text-gray-500"
