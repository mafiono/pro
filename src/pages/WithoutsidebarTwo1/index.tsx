...
const WithoutsidebarTwo1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-10 items-center justify-start mx-auto pb-16 w-full">
        ...
        <div className="flex flex-col gap-9 h-[3267px] md:h-auto items-center justify-start max-w-[1270px] mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-col gap-9 items-center justify-start w-full">
            ...
            <div className="bg-blue_gray-900_01 md:h-[137px] h-[244px] p-3 relative rounded-md w-[37%] sm:w-full">
              <div className="absolute bottom-[18%] md:h-[137px] h-[146px] inset-x-[0] mx-auto w-[72%]">
                <Img
                  ...
                  src="images/img_star1_58x134.svg"
                  alt="starOne"
                />
            ...
            />
            <List
              className="sm:flex-col flex-row md:gap-10 gap-[70px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-start w-auto md:w-full"
            ...
            >
              ...
              >
                <div className="flex flex-col gap-5 items-center justify-start mb-[17px] w-[81%] md:w-full">
                  <Img
                    className="h-[50px]"
                    src="images/img_thumbsup_orange_300_50x52.svg"
                    alt="thumbsup"
                  />
                  <Text
                    className="text-center text-sm text-white-A700"
...
export default WithoutsidebarTwo1Page;
