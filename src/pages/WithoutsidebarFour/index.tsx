...
const WithoutsidebarFourPage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[21px] items-center justify-start mx-auto pb-[34px] w-full">
        ...
        <div className="flex flex-col gap-9 items-start justify-start max-w-[1264px] mx-auto md:px-5 w-full">
          <div className="bg-gray-900 flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1264px] p-1 rounded-md w-full">
          ...
          <div className="flex flex-col items-start justify-start w-auto md:w-full">
            <div className="gap-4 md:gap-5 grid sm:grid-cols-1 md:grid-cols-4 grid-cols-8 justify-center min-h-[auto] w-full">
              {new Array(56).fill({}).map((props, index) => (
                <React.Fragment
...
export default WithoutsidebarFourPage;
