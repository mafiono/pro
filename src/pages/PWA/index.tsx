    ...
    <>
      <div className="bg-blue_gray-900 flex flex-col font-roboto gap-[7px] items-center justify-end mx-auto pt-2 w-full">
        ...
        <div className="font-montserrat h-[2653px] md:h-[2813px] md:px-5 relative w-full">
          <div className="flex flex-col gap-[35px] h-full items-center justify-start ml-auto mr-52 mt-[105px] w-[66%]">
          ...
          <div className="absolute h-[2653px] md:h-[2813px] inset-[0] justify-center m-auto w-full">
            <div className="h-[2653px] md:h-[2813px] m-auto w-full">
              ...
              <div className="absolute bg-blue_gray-900_01 flex md:flex-col flex-row md:gap-10 gap-[174px] items-center justify-center p-5 right-[11%] rounded-md top-[37%] w-[66%]">
                <Text
                ...
                <div className="flex md:flex-col flex-row gap-6 items-center justify-start mr-[97px] w-auto md:w-full">
