...
const WithoutsidebarTwoPage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat items-center justify-start mx-auto pb-[66px] w-full">
        ...
        <div className="flex flex-col items-center justify-start max-w-[945px] mt-[45px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-start w-full">
            <div className="h-[400px] relative w-full">
              <Img
                className="h-[400px] m-auto object-cover rounded-md w-full"
                src="images/img_winninghomepagebanner37_400x945.png"
                alt="winninghomepage"
              />
              <div className="absolute flex flex-col items-center justify-start left-[0] top-[21%] w-[41%]">
        ...
        <List
          className="sm:flex-col flex-row gap-4 grid md:grid-cols-1 grid-cols-2 justify-start max-w-[944px] mt-[35px] mx-auto md:px-5 w-full"
          ...
          <div className="flex flex-row sm:gap-10 items-center justify-between max-w-[944px] w-full">
            ...
            <div className="flex flex-row gap-[5px] items-start justify-start w-auto">
              <Button
                ...
                variant="fill"
              >
                <Img src="images/img_arrowdown_gray_600.svg" alt="arrowdown" />
              </Button>
              <Button
                className="flex h-[35px] items-center justify-center rounded-[3px] w-[35px]"
                shape="round"
...
export default WithoutsidebarTwoPage;
