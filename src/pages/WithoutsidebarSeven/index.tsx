...
const WithoutsidebarSevenPage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-10 items-center justify-start mx-auto pb-[284px] w-full">
        ...
        <div className="flex flex-col gap-9 items-center justify-start max-w-[1270px] mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-col items-center justify-start w-full">
            ...
            <Text
              className="leading-[20.00px] mt-[73px] text-sm text-white-A700"
            ...
            <Img
              className="h-[11px] mt-9 w-[598px]"
              src="images/img_divider.svg"
              alt="divider"
            />
            <List
              className="sm:flex-col flex-row md:gap-10 gap-[70px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-start mt-9 w-auto md:w-full"
              orientation="horizontal"
            >
              <div
                className="bg-cover bg-no-repeat flex flex-col h-[230px] items-center justify-start p-5 w-full"
                style={{ backgroundImage: "url('images/img_vipmanager.svg')" }}
              >
                <div className="flex flex-col gap-5 items-center justify-start mb-[17px] w-[81%] md:w-full">
                  <Img
                    className="h-[50px]"
            ...
            <Text
              className="leading-[20.00px] mt-9 text-sm text-white-A700"
              size="txtMontserratBold14"
            >
              <span className="md:text-3xl sm:text-[28px] text-white-A700 font-montserrat text-left text-[32px] font-bold">
                Our Loyalty Levels
            ...
            <div className="flex flex-col gap-4 items-center justify-start mt-9 w-auto md:w-full">
              <List
                className="flex flex-col gap-4 items-center w-full"
                orientation="vertical"
              >
                <div className="flex-1 gap-4 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-start justify-start max-w-[1270px] w-full">
                  ...
                  <C1920WithoutSidebarSevenLevelcard
                    ...
                    style={{
                      backgroundImage: "url('images/img_levelcard.svg')",
                    }}
                ...
                <div className="md:flex-1 gap-4 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-start justify-start w-auto md:w-full">
                  <C1920WithoutSidebarSevenLevelcard
                    className="flex flex-col h-[304px] items-center justify-start w-[304px]"
                    vectorimage="images/img_vector_blue_gray_900.svg"
                    checkmarkimage="images/img_checkmark.svg"
                  ...
                  />
                  <C1920WithoutSidebarSevenLevelcard
                    className="bg-cover bg-no-repeat flex flex-col h-[304px] items-center justify-end p-[51px] md:px-10 sm:px-5 w-[304px]"
                    style={{
                      backgroundImage: "url('images/img_levelcard.svg')",
                    }}
            ...
            <Line className="bg-blue_gray-700 h-px mt-9 w-full" />
            <div className="flex flex-col gap-[33px] items-start justify-start mt-[35px] w-auto md:w-full">
...
export default WithoutsidebarSevenPage;
