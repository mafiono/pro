...
const SearchPage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 font-montserrat h-[894px] mx-auto relative w-full">
        <div className="absolute bottom-[0] flex flex-col gap-9 inset-x-[0] items-center justify-end max-w-[945px] mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-9 items-center justify-start w-full">
            <Img
              className="h-[653px] sm:h-auto object-cover rounded-md w-full"
              src="images/img_20210324.png"
              alt="20210324"
            />
            <div className="bg-gray-900 flex md:flex-col flex-row md:gap-10 h-12 md:h-auto items-center justify-between max-w-[944px] sm:px-5 px-6 py-1 rounded-md w-full">
            ...
            <div className="flex flex-col gap-[13px] items-start justify-start w-auto md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-4 items-start justify-start w-auto md:w-full">
                <PWAOneGamecard
                  className="md:h-[150px] h-[200px] relative rounded-md w-[16%] md:w-full"
                ...
                >
                  <PWAOneGamecard1 className="h-[200px] relative rounded-md w-full" />
                  <PWAOneGamecard1
                    className="h-[200px] relative rounded-md w-full"
                ...
                <PWAOneGamecard
                  ...
                  priceOne="EUR 8.000.000"
                />
                <PWAOneGamecard2 className="h-[200px] relative rounded-md w-[16%] md:w-full" />
                <PWAOneGamecard
                  className="md:h-[150px] h-[200px] relative rounded-md w-[16%] md:w-full"
            ...
            <div className="flex flex-col items-center justify-start rounded-md w-full">
              <div className="bg-blue_gray-900_01 h-[344px] md:h-[356px] sm:h-[426px] md:px-10 sm:px-5 px-[50px] py-10 relative rounded-md w-[945px] md:w-full">
                <div className="absolute bottom-[12%] h-[304px] md:h-[356px] sm:h-[426px] inset-x-[0] mx-auto w-full">
                  <div className="absolute flex flex-col md:gap-10 gap-[110px] h-full inset-[0] items-center justify-center m-auto w-[87%]">
                    <div className="flex flex-col gap-2.5 items-start justify-start max-w-[817px] w-full">
                      <Text
                        className="text-base text-white-A700 w-auto"
                        size="txtMontserratBold16"
                      >
          ...
          <div className="flex flex-col gap-[33px] items-start justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col gap-[18px] items-start justify-start w-auto md:w-full">
              <Text
                className="md:max-w-full max-w-screen-sm text-base text-white-A700 w-full"
                size="txtMontserratBold16"
              >
                Payment Methods
              </Text>
        ...
        <Header7 className="bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-center mx-auto md:px-5 shadow-bs1 w-full" />
        <div className="absolute bg-blue_gray-900_e5 bottom-[0] flex flex-col font-roboto gap-4 inset-x-[0] items-center justify-start mx-auto p-[60px] md:px-10 sm:px-5 w-full">
          <Input
            name="search_One"
            placeholder="Pirates 2 Mu..."
            className="leading-[normal] p-0 placeholder:text-white-A700 text-center text-sm w-full"
            wrapClassName="border border-solid border-teal-400 flex w-[84%]"
            prefix={
              <Img
                className="mt-auto mb-[3px] h-[21px] mr-2.5"
            ...
            variant="fill"
          ></Input>
          <div className="flex flex-col font-montserrat gap-[13px] items-start justify-start max-w-[944px] mb-[1704px] w-full">
            <div className="flex flex-col items-center justify-start max-w-[944px] w-full">
              <Text
                className="text-base text-white-A700 w-auto"
                size="txtMontserratBold16"
              >
