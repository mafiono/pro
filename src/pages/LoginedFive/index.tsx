...
const LoginedFivePage: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat items-center justify-start mx-auto pb-9 w-full">
        <div className="flex flex-col gap-[23px] items-center justify-start w-full">
          ...
          <div className="flex flex-col font-roboto items-center justify-start max-w-[945px] mx-auto md:px-5 w-full">
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between w-full">
              <Img
                className="h-[321px] md:h-auto object-cover rounded-md"
                src="images/img_20210324.png"
                alt="20210324"
              />
              <div className="bg-gray-900 flex flex-col items-start justify-end pl-5 pt-5 rounded-md">
                <Input
                  name="search_One"
                  placeholder="Pirates 2 Mu..."
                  className="leading-[normal] p-0 placeholder:text-white-A700 text-center text-sm w-full"
                  wrapClassName="border border-solid border-teal-400 flex ml-11 md:ml-[0] rounded-[7px] w-[76%]"
                  prefix={
                    <Img
                  ...
                  variant="fill"
                ></Input>
                <div className="flex flex-col font-montserrat items-start justify-start ml-11 md:ml-[0] mt-0.5 rounded-md w-[91%] md:w-full">
                  <div className="h-[258px] md:h-[260px] relative w-[336px]">
                    <div className="flex flex-col h-full items-center justify-start m-auto w-full">
                      <div className="flex flex-col items-center justify-start w-full">
                        ...
                        >
                          ...
                          />
                          <C1248LoginedThreeGamesearch1 className="bg-gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full" />
                          <C1248LoginedThreeGamesearch
                            className="bg-blue_gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full"
                    ...
                    <Img
                      className="absolute bottom-[0] h-[235px] right-[0]"
            ...
            <div className="bg-gray-900 flex sm:flex-col flex-row font-montserrat sm:gap-10 h-12 md:h-auto items-center justify-between max-w-[944px] mt-[31px] sm:px-5 px-6 py-1 rounded-md w-full">
            ...
            <div className="flex flex-col font-montserrat gap-9 items-center justify-start mt-9 w-full">
              ...
              <div className="flex flex-col items-center justify-start rounded-md w-full">
                <div className="bg-blue_gray-900_01 md:h-[334px] h-[344px] md:px-10 sm:px-5 px-[50px] py-10 relative rounded-md w-[945px] md:w-full">
...
export default LoginedFivePage;
