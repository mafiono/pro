...
import C1920LoginedTwoGamesearch from "components/C1920LoginedTwoGamesearch";
import C1920LoginedTwoGamesearch1 from "components/C1920LoginedTwoGamesearch1";
...
const LoginedTwo1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat items-center justify-start mx-auto pb-14 w-full">
        <div className="flex flex-col gap-[19px] items-center justify-start w-full">
          ...
          <div className="flex flex-col font-roboto items-center justify-start max-w-[1264px] mx-auto md:px-5 w-full">
            <div className="flex sm:flex-col flex-row gap-4 items-center justify-between w-full">
              <Img
                className="h-[432px] md:h-auto object-cover rounded-md"
            ...
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between mt-4 w-full">
              <Img
                className="h-[432px] md:h-auto object-cover rounded-md"
                src="images/img_20210324.png"
                alt="20210324_Two"
              />
              <div className="bg-gray-900 flex flex-col items-center justify-end pt-5 px-5 rounded-md">
                <Input
                  name="search_One"
                  placeholder="Pirates 2 Mu..."
                  className="leading-[normal] p-0 placeholder:text-white-A700 text-center text-sm w-full"
                  wrapClassName="border border-solid border-teal-400 flex w-4/5"
                  prefix={
                    <Img
                  ...
                  variant="fill"
                ></Input>
                <div className="flex flex-col font-montserrat items-center justify-start mt-0.5 rounded-md w-4/5 md:w-full">
                  <div className="h-[369px] md:h-[372px] relative rounded-md w-[464px] sm:w-full">
                    <div className="flex flex-col h-full items-center justify-start m-auto w-full">
                      <div className="flex flex-col items-center justify-start w-full">
                        ...
                        >
                          <C1920LoginedTwoGamesearch
                            className="bg-blue_gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full"
                            image1="images/img_notombofakhenaten_64x64.png"
                          />
                          <C1920LoginedTwoGamesearch1 className="bg-gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full" />
                          <C1920LoginedTwoGamesearch
                            className="bg-blue_gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full"
                            image1="images/img_notombofakhenaten_7.png"
                          />
                          <C1920LoginedTwoGamesearch
                            className="bg-blue_gray-900 flex flex-1 flex-row gap-2.5 items-center justify-start my-0 p-1.5 w-full"
                            image1="images/img_notombofakhenaten_33x64.png"
                          />
                        </List>
                        <C1920LoginedTwoGamesearch className="bg-blue_gray-900 flex h-[57px] justify-end relative w-full" />
                      </div>
                    </div>
                    <Img
                      className="absolute h-[334px] inset-y-[0] my-auto right-[0]"
            ...
            <div className="bg-gray-900 flex sm:flex-col flex-row font-montserrat md:gap-10 h-12 md:h-auto items-center justify-between max-w-[1264px] mt-[31px] sm:px-5 px-6 py-1 rounded-md w-full">
            ...
            <div className="flex flex-col font-montserrat gap-9 items-center justify-start mt-9 w-full">
                ...
                <div className="bg-blue_gray-900_01 md:h-[334px] h-[344px] md:px-10 sm:px-5 px-[50px] py-10 relative rounded-md w-[1264px] md:w-full">
                  <div className="absolute bottom-[12%] h-[304px] inset-x-[0] mx-auto w-full">
                    <div className="absolute flex flex-col gap-2.5 h-full inset-[0] items-start justify-start m-auto w-auto">
                      ...
                      >
                        <>
                          The Dog House Megaways is the game developed by
                          renowned studio Pragmatic Play. Released on 17.07.2020
                          it became an instant success among gamblers for its
                          immersive engine and high-quality artwork. This review
                          explains all of its main characteristics that along
                          with free test mode available on Clash of Slots give a
                          good idea of experience you’ll be getting.
                          <br />
                          <br />
                          Playing the Dog House Megaways slot, you will again
                          have to go to a chic hotel for dogs, which has become
                          much larger due to an increased play field, to see in
                          what conditions our four-legged friends can live.
                          <br />
                          <br />A significant difference between the two The Dog
                          House slots in the increased play field; in the first
                          version it is very standard: five reels and 20
                          paylines, and in the second version, thanks to the
                          Megaways engine, you have six reels with a different
                          number of symbols on each of them, which in total can
                          provide the maximum number of ways to win, namely
                          117649. A winning combination is created when the same
                          symbols appear on successive reels in any position
                          starting from the first.
                          <br />
                          <br />
                          You can play The Dog House Megaways slot on all
                          devices, the bets range from $0.20 to 100 per spin.
                          You can play the Dog House slot in manual mode, or
                          click the Autoplay button, where you can choose up to
                          1000 auto spins. The Dog House Megaways has high
                          dispersion, and RTP of 96.55%, while the maximum
                          payout you can get is 12305 times your bet.
                        </>
                      </Text>
                    </div>
            ...
            <div className="flex flex-col font-montserrat gap-[33px] items-start justify-start mt-[35px] w-auto md:w-full">
...
export default LoginedTwo1Page;
