...
const Registration1248Page: React.FC = () => {
  return (
    <>
      <div className="flex font-montserrat h-[1080px] justify-end mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900_a2_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[232px] md:px-10 sm:px-5 w-full">
          <div className="bg-gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-center max-w-[784px] my-2 md:px-5 rounded-md shadow-bs5 w-full">
            ...
            <div className="bg-blue_gray-800_02 flex sm:flex-1 flex-col gap-4 h-[600px] md:h-auto items-center justify-center pb-2 pt-4 rounded-br-md rounded-tr-md w-[464px] sm:w-full">
              <Img
                className="h-6 w-6"
...
export default Registration1248Page;
