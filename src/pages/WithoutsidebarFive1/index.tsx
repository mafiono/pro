...
const WithoutsidebarFive1Page: React.FC = () => {
  return (
    <>
      <div className="bg-blue_gray-900 flex flex-col font-montserrat gap-[21px] items-center justify-start mx-auto pb-10 w-full">
        ...
        <div className="flex flex-col gap-9 items-start justify-start max-w-[945px] mx-auto md:px-5 w-full">
          <div className="bg-gray-900 flex flex-row sm:gap-10 items-center justify-between max-w-[944px] p-1 rounded-md w-full">
          ...
          <div className="flex flex-col gap-6 items-center justify-end max-w-[944px] w-full">
            <List
              className="flex flex-col gap-6 items-center w-full"
              orientation="vertical"
            >
              <div className="flex flex-1 flex-col items-start justify-start max-w-[944px] w-full">
...
export default WithoutsidebarFive1Page;
