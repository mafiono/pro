...
type Header6Props = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
> &
  Partial<{}>;

const Header6: React.FC<Header6Props> = (props) => {
  return (
    <>
      <header className={props.className}>
        ...
        <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1050px] md:ml-[0] ml-[11px] mr-[152px] md:mt-0 my-2.5 w-full">
          ...
          <div className="flex flex-row gap-3 items-start justify-start w-auto">
            ...
            <div className="bg-gray-900 flex flex-row gap-[7px] items-center justify-center pl-[13px] rounded w-[51%]">
