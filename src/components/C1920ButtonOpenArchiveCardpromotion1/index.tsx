...
type C1920ButtonOpenArchiveCardpromotion1Props = Omit<
...
const C1920ButtonOpenArchiveCardpromotion1: React.FC<
  C1920ButtonOpenArchiveCardpromotion1Props
> = (props) => {
  return (
    <>
...
C1920ButtonOpenArchiveCardpromotion1.defaultProps = {
...
export default C1920ButtonOpenArchiveCardpromotion1;
